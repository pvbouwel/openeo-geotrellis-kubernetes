...
@non_standard_process(
    ProcessSpec(
        ...
        The implementation is based on SNAP and defined as a CWL (Common Workflow Language) available here: [sar_coherence.cwl](https://github.com/cloudinsar/s1-workflows/blob/main/cwl/sar_coherence.cwl)
